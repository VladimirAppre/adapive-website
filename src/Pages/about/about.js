...
import reduxSagaImg from '../../assets/about/react-redux.gif';
          ...
          <Col sm={8}>
            <Tab.Content className='mt-3'>
              <Tab.Pane eventKey='design'>
                <img
                  src='https://i.ibb.co/f86Y6KQ/ava-job.jpg'
              ...
              <Tab.Content>
                <Tab.Pane eventKey='elbrus-team'>
                  <img
                    src='https://i.ibb.co/6NMGNKw/Image-from-i-OS.jpg'
                    className='img-fluid rounded shadow'
                    alt='elbrus team'
                  />
              ...
              <Tab.Content>
                <Tab.Pane eventKey='programming'>
                  ...
                  <img
                    src='https://i.redd.it/vezwyo0qq4lz.png'
                    className='img-fluid rounded shadow'
                    alt='schema'
                  />
              ...
              <Tab.Content>
                <Tab.Pane eventKey='framework'>
                  ...
                  <span>
                    ...
                    href='https://www.npmtrends.com/' className='text-info'>npmtrends.com.</a></span>
                  <img
                    alt='statistics'
